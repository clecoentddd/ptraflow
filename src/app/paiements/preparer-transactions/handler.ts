...
export function preparerTransactionsCommandHandler(
  ...
  // This is a simplification; in a real scenario, we might query a projection of payment plans.
  ...
  ) as PlanDePaiementValideEvent & { payload: { detailCalcul: { month: string, aPayer: number }[] } } | undefined;
  ...
  // In a real app, we might dispatch a final event like TRANSACTIONS_PREPAREES
  // to update the todolist. For this test, generating the events is enough.
